...
export default function Pricing() {
  return (
    <section className="relative py-16 md:py-20 bg-gradient-to-br from-emerald-900/80 via-teal-900/70 to-green-900/60 overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-sm md:text-lg lg:text-xl text-gray-200 max-w-3xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 max-w-6xl mx-auto">
          {/* Free Plan */}
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl md:rounded-3xl p-6 md:p-8 shadow-xl border-2 border-white/20 relative">
            <div className="text-center mb-6 md:mb-8">
              <div className="w-14 h-14 md:w-16 md:h-16 bg-blue-100 rounded-2xl flex items-center justify-center mx-auto mb-3 md:mb-4">
                <Zap className="w-6 h-6 md:w-8 md:h-8 text-blue-600" />
              </div>
              <h3 className="text-lg md:text-2xl font-bold text-white mb-1 md:mb-2">
                Starter Pack
              </h3>
              <p className="text-xs md:text-base text-gray-200 mb-4 md:mb-6">
                Perfect untuk yang mau coba dulu
              </p>
              ...
              <div className="mb-4 md:mb-6">
                ...
                <div className="text-xs md:text-sm text-gray-300">5 Hari</div>
              </div>
            </div>
            ...
            <Button className="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 md:py-4 rounded-xl md:rounded-2xl text-sm md:text-lg font-semibold">
              Mulai Sekarang
            </Button>

            <p className="text-center text-xs md:text-sm text-gray-300 mt-3 md:mt-4">
              No credit card required
            </p>
          </div>

          {/* Premium Plan */}
          <div className="bg-gradient-to-br from-[#0f172a] to-[#1e293b] rounded-2xl md:rounded-3xl p-6 md:p-8 shadow-2xl border-2 border-[#00ff88] relative overflow-hidden">
            {/* Popular Badge */}
            <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
              <div className="bg-[#00ff88] text-[#0f172a] px-4 md:px-6 py-1.5 md:py-2 rounded-full font-bold text-xs md:text-sm flex items-center gap-1.5 md:gap-2">
            ...
            <div className="text-center mb-6 md:mb-8 text-white">
              <div className="w-14 h-14 md:w-16 md:h-16 bg-[#00ff88]/20 rounded-2xl flex items-center justify-center mx-auto mb-3 md:mb-4">
                <Crown className="w-6 h-6 md:w-8 md:h-8 text-[#00ff88]" />
              </div>
              <h3 className="text-lg md:text-2xl font-bold mb-1 md:mb-2">
                Master Premium
              </h3>
              <p className="text-xs md:text-base text-gray-300 mb-4 md:mb-6">
                All-in-one automation mastery
              </p>
              ...
              <div className="mb-4 md:mb-6">
                <div className="flex items-center justify-center gap-1.5 md:gap-2 mb-1 md:mb-2">
                  ...
                  <span className="bg-red-500 text-white px-2 md:px-3 py-0.5 md:py-1 rounded-full text-xs md:text-sm font-bold">
                    50% OFF
                  </span>
                </div>
                <div className="text-2xl md:text-4xl lg:text-5xl font-bold text-[#00ff88]">
                  Rp 1.499.000
                </div>
            ...
            <div className="space-y-2 md:space-y-4 mb-6 md:mb-8 text-white">
              {[
                "50+ Advanced Tutorial Videos",
                "30+ Ready-to-Use Templates",
                "VIP Community Access",
                "1-on-1 Consultation Call",
                "Private Masterclass Series",
                "Priority Support (24/7)",
                "Lifetime Updates",
              ].map((item, i) => (
                <div key={i} className="flex items-center gap-2 md:gap-3">
                  <div className="w-5 h-5 md:w-6 md:h-6 bg-[#00ff88] rounded-full flex items-center justify-center flex-shrink-0">
                    <Check className="w-3 h-3 md:w-4 md:h-4 text-[#0f172a]" />
                  </div>
              ...
              <div className="flex items-center gap-2 md:gap-3">
                <div className="w-5 h-5 md:w-6 md:h-6 bg-[#00ff88] rounded-full flex items-center justify-center flex-shrink-0">
                  <Gift className="w-3 h-3 md:w-4 md:h-4 text-[#0f172a]" />
                </div>
                <span className="text-xs md:text-base text-[#00ff88] font-semibold">
                  Bonus Senilai Rp 10 Juta!
                </span>
              </div>
            </div>

            <Button className="w-full bg-[#00ff88] hover:bg-[#00cc6a] text-[#0f172a] py-3 md:py-4 rounded-xl md:rounded-2xl text-sm md:text-lg font-bold mb-3 md:mb-4 transform hover:scale-105 transition-all duration-300">
            ...
            <div className="text-center text-gray-300 text-xs md:text-sm">
              <div className="flex items-center justify-center gap-1.5 md:gap-2 mb-1.5 md:mb-2">
                <Star className="w-3 h-3 md:w-4 md:h-4 text-[#00ff88]" />
